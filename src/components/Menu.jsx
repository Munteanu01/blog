...
export default function Menu() {
    ...
    <nav className="flex justify-between top-0">
        ...
        <div className={`md:py-0 py-10 absolute md:static bg-white md:z-auto z-[1] w-full md:w-auto transition-all duration-[400ms] ease-in-out ${isOpen ? 'top-[40px] ':'top-[-100px]'}`}>

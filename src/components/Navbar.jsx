...
export default function Menu() {
    ...
    return (
    <nav className={`bg-black flex justify-between lg:justify-end md:ml-20 sticky transition-all duration-[0.4s] ${visible ? "top-0" : "top-[-150px]"}`}>
        <Link to="/Home" className="z-[2]"><img className="w-[48px] md:w-[50px] ml-5" src="../img/logo.png"></img></Link> 

...
export default function Menu() {
    ...
    return (
    <nav className={`dark:bg-black bg-white flex justify-between lg:justify-end py-2 md:pl-32 lg:pl-0 lg:pr-10 sticky transition-all duration-[0.4s] ${visible ? "top-0" : "top-[-150px]"}`}>
